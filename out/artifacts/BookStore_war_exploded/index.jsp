      ...
      <script type="text/javascript">
          ...
          function UserHome() {
              ...
              if (getCookie("username")!=="" && getCookie("value")!==""){
                  ...
                  window.alert("请先登录")
                  window.open("${pageContext.request.contextPath}/UserLogin");
              }
          }
      ...
      <div class="container-fluid">
          <div class="row col-md-12">
              ...
              <div class="col-md-offset-4">
                  <%--Querybook--%>
                  <form action="${pageContext.request.contextPath}/QueryBook" method="get" class="navbar-form navbar-left" role="search" >
              ...
              <div class="col-md-2" >
                  <img id="userImage" class="img-circle" src="${pageContext.request.contextPath }/img/header.jpg"
